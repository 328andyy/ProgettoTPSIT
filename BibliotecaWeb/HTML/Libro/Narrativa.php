...
<head>
    ...
    <title>Sezione Libri - Narrativa</title>
    <link rel="stylesheet" href="../../CSS/Style.css">
    <link rel="stylesheet" href="../../CSS/Libro/StyleNarrativa.css">
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
</head>
<body>

    <img src="../../Immagini/Narrativa.jpg" class="sfondo-narrativa" alt="Sfondo Narrativa">
    ...
    // Inizializza un array vuoto che conterrà solo i libri di genere narrativa trovati
    $risultati_narrativa = [];
    ...
    if (file_exists($file_path)) {
        ...
        foreach ($righe as $riga) {
            ...
            if (count($dati_libro) >= 6) {
                ...
                if (strtolower(trim($genere)) === 'narrativa') {
                
                    // Se il genere è narrativa, aggiunge il libro all'array dei risultati
                    $risultati_narrativa[] = [
                        'titolo' => $titolo,
                        'autore' => $autore,
                        'tipo'   => $tipo,
    ...
    echo '<h3>Libri di Genere: narrativa</h3>';

    // Se l'array ha trovato libri narrativa
    if (!empty($risultati_narrativa)) {
        // Apre la lista non ordinata
        echo '<ul>';
    
        // Cicla i libri trovati per stamparli a schermo
        foreach ($risultati_narrativa as $libro) {
            echo '<li>';
        ...
        // Messaggio mostrato nel caso in cui non ci siano libri narrativa nel file di testo
        echo '<p>Nessun libro narrativa disponibile al momento.</p>';
    }
