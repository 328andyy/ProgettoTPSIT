...
<head>
    ...
    <title>Sezione Libri - Umoristico</title>
    <link rel="stylesheet" href="../../CSS/Style.css">
    <link rel="stylesheet" href="../../CSS/Libro/StyleUmoristico.css">
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
</head>
<body>

    <img src="../../Immagini/Umoristico.jpg" class="sfondo-umoristico" alt="Sfondo Umoristico">
    ...
    // Inizializza un array vuoto che conterrà solo i libri di genere umoristico trovati
    $risultati_umoristico = [];
    ...
    if (file_exists($file_path)) {
        ...
        foreach ($righe as $riga) {
            ...
            if (count($dati_libro) >= 6) {
                ...
                if (strtolower(trim($genere)) === 'umoristico') {
                
                    // Se il genere è umoristico, aggiunge il libro all'array dei risultati
                    $risultati_umoristico[] = [
                        'titolo' => $titolo,
                        'autore' => $autore,
                        'tipo'   => $tipo,
    ...
    echo '<h3>Libri di Genere: umoristico</h3>';

    // Se l'array ha trovato libri umoristico
    if (!empty($risultati_umoristico)) {
        // Apre la lista non ordinata
        echo '<ul>';
    
        // Cicla i libri trovati per stamparli a schermo
        foreach ($risultati_umoristico as $libro) {
            echo '<li>';
        ...
        // Messaggio mostrato nel caso in cui non ci siano libri umoristico nel file di testo
        echo '<p>Nessun libro umoristico disponibile al momento.</p>';
    }
