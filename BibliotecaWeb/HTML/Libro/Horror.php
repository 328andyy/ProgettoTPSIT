...
<head>
    ...
    <title>Sezione Libri - Horror</title>
    <link rel="stylesheet" href="../../CSS/Style.css">
    <link rel="stylesheet" href="../../CSS/Libro/StyleHorror.css">
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
</head>
<body>

    <img src="../../Immagini/Horror.jpg" class="sfondo-horror" alt="Sfondo Horror">
    ...
    // Inizializza un array vuoto che conterrà solo i libri di genere horror trovati
    $risultati_horror = [];
    ...
    if (file_exists($file_path)) {
        ...
        foreach ($righe as $riga) {
            ...
            if (count($dati_libro) >= 6) {
                ...
                if (strtolower(trim($genere)) === 'horror') {
                
                    // Se il genere è horror, aggiunge il libro all'array dei risultati
                    $risultati_horror[] = [
                        'titolo' => $titolo,
                        'autore' => $autore,
                        'tipo'   => $tipo,
    ...
    echo '<h3>Libri di Genere: horror</h3>';

    // Se l'array ha trovato libri horror
    if (!empty($risultati_horror)) {
        // Apre la lista non ordinata
        echo '<ul>';
    
        // Cicla i libri trovati per stamparli a schermo
        foreach ($risultati_horror as $libro) {
            echo '<li>';
        ...
        // Messaggio mostrato nel caso in cui non ci siano libri horror nel file di testo
        echo '<p>Nessun libro horror disponibile al momento.</p>';
    }
