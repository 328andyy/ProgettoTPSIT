...
<head>
    ...
    <title>Sezione Libri - Storico</title>
    <link rel="stylesheet" href="../../CSS/Style.css">
    <link rel="stylesheet" href="../../CSS/Libro/StyleStorico.css">
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
</head>
<body>

    <img src="../../Immagini/Storico.jpg" class="sfondo-storico" alt="Sfondo Storico">
    ...
    // Inizializza un array vuoto che conterrà solo i libri di genere storico trovati
    $risultati_storico = [];
    ...
    if (file_exists($file_path)) {
        ...
        foreach ($righe as $riga) {
            ...
            if (count($dati_libro) >= 6) {
                ...
                if (strtolower(trim($genere)) === 'storico') {
                
                    // Se il genere è storico, aggiunge il libro all'array dei risultati
                    $risultati_storico[] = [
                        'titolo' => $titolo,
                        'autore' => $autore,
                        'tipo'   => $tipo,
    ...
    echo '<h3>Libri di Genere: storico</h3>';

    // Se l'array ha trovato libri storico
    if (!empty($risultati_storico)) {
        // Apre la lista non ordinata
        echo '<ul>';
    
        // Cicla i libri trovati per stamparli a schermo
        foreach ($risultati_storico as $libro) {
            echo '<li>';
        ...
        // Messaggio mostrato nel caso in cui non ci siano libri storico nel file di testo
        echo '<p>Nessun libro storico disponibile al momento.</p>';
    }
