...
<head>
    ...
    <title>Sezione Libri - Avventura</title>
    <link rel="stylesheet" href="../../CSS/Style.css">
    <link rel="stylesheet" href="../../CSS/Libro/StyleAvventura.css">
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
</head>
<body>

    <img src="../../Immagini/Avventura.jpg" class="sfondo-avventura" alt="Sfondo Avventura">
    ...
    // Inizializza un array vuoto che conterrà solo i libri di genere avventura trovati
    $risultati_avventura = [];
    ...
    if (file_exists($file_path)) {
        ...
        foreach ($righe as $riga) {
            ...
            if (count($dati_libro) >= 6) {
                ...
                if (strtolower(trim($genere)) === 'avventura') {
                
                    // Se il genere è avventura, aggiunge il libro all'array dei risultati
                    $risultati_avventura[] = [
                        'titolo' => $titolo,
                        'autore' => $autore,
                        'tipo'   => $tipo,
    ...
    echo '<h3>Libri di Genere: avventura</h3>';

    // Se l'array ha trovato libri avventura
    if (!empty($risultati_avventura)) {
        // Apre la lista non ordinata
        echo '<ul>';
    
        // Cicla i libri trovati per stamparli a schermo
        foreach ($risultati_avventura as $libro) {
            echo '<li>';
        ...
        // Messaggio mostrato nel caso in cui non ci siano libri avventura nel file di testo
        echo '<p>Nessun libro avventura disponibile al momento.</p>';
    }
