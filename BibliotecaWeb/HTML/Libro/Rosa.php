...
<head>
    ...
    <title>Sezione Libri - Rosa</title>
    <link rel="stylesheet" href="../../CSS/Style.css">
    <link rel="stylesheet" href="../../CSS/Libro/StyleRosa.css">
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
</head>
<body>

    <img src="../../Immagini/Rosa.jpg" class="sfondo-rosa" alt="Sfondo Rosa">
    ...
    // Inizializza un array vuoto che conterrà solo i libri di genere rosa trovati
    $risultati_rosa = [];
    ...
    if (file_exists($file_path)) {
        ...
        foreach ($righe as $riga) {
            ...
            if (count($dati_libro) >= 6) {
                ...
                if (strtolower(trim($genere)) === 'rosa') {
                
                    // Se il genere è rosa, aggiunge il libro all'array dei risultati
                    $risultati_rosa[] = [
                        'titolo' => $titolo,
                        'autore' => $autore,
                        'tipo'   => $tipo,
    ...
    echo '<h3>Libri di Genere: rosa</h3>';

    // Se l'array ha trovato libri rosa
    if (!empty($risultati_rosa)) {
        // Apre la lista non ordinata
        echo '<ul>';
    
        // Cicla i libri trovati per stamparli a schermo
        foreach ($risultati_rosa as $libro) {
            echo '<li>';
        ...
        // Messaggio mostrato nel caso in cui non ci siano libri rosa nel file di testo
        echo '<p>Nessun libro rosa disponibile al momento.</p>';
    }
