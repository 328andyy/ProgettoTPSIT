...
<head>
    ...
    <title>Sezione Libri - Biografico</title>
    <link rel="stylesheet" href="../../CSS/Style.css">
    <link rel="stylesheet" href="../../CSS/Libro/StyleBiografico.css">
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
</head>
<body>

    <img src="../../Immagini/Biografico.jpg" class="sfondo-biografico" alt="Sfondo Biografico">
    ...
    // Inizializza un array vuoto che conterrà solo i libri di genere biografico trovati
    $risultati_biografico = [];
    ...
    if (file_exists($file_path)) {
        ...
        foreach ($righe as $riga) {
            ...
            if (count($dati_libro) >= 6) {
                ...
                if (strtolower(trim($genere)) === 'biografico') {
                
                    // Se il genere è biografico, aggiunge il libro all'array dei risultati
                    $risultati_biografico[] = [
                        'titolo' => $titolo,
                        'autore' => $autore,
                        'tipo'   => $tipo,
    ...
    echo '<h3>Libri di Genere: biografico</h3>';

    // Se l'array ha trovato libri biografico
    if (!empty($risultati_biografico)) {
        // Apre la lista non ordinata
        echo '<ul>';
    
        // Cicla i libri trovati per stamparli a schermo
        foreach ($risultati_biografico as $libro) {
            echo '<li>';
        ...
        // Messaggio mostrato nel caso in cui non ci siano libri biografico nel file di testo
        echo '<p>Nessun libro biografico disponibile al momento.</p>';
    }
