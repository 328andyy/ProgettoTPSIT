...
<head>
    ...
    <title>Sezione Multimediale - Audio</title>
    <link rel="stylesheet" href="../../CSS/Style.css">
    <link rel="stylesheet" href="../../CSS/Multimediale/StyleAudio.css">
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
</head>
<body>

    <img src="../../Immagini/Audio.jpg" class="sfondo-audio" alt="Sfondo Audio">
    ...
    // Inizializza un array vuoto che conterrà solo i file di genere audio trovati
    $risultati_audio = [];
        ...
        foreach ($righe as $riga) {
            ...
            if (count($dati_file) >= 6) {
                ...
                if (strtolower(trim($genere)) === 'audio') {
                    ...
                    // Se il genere è audio, aggiunge il file all'array dei risultati
                    $risultati_audio[] = [
                        'titolo' => $titolo,
                        'autore' => $autore,
                        'tipo'   => $tipo,
    ...
    echo '<h3>file di Genere: audio</h3>';

    // Se l'array ha trovato file audio
    if (!empty($risultati_audio)) {
        // Apre la lista non ordinata
        echo '<ul>';
    
        // Cicla i file trovati per stamparli a schermo
        foreach ($risultati_audio as $file) {
            echo '<li>';
        ...
        // Messaggio mostrato nel caso in cui non ci siano file audio nel file di testo
        echo '<p>Nessun file audio disponibile al momento.</p>';
    }
