...
<head>
    ...
    <title>Sezione Multimediale - Video</title>
    <link rel="stylesheet" href="../../CSS/Style.css">
    <link rel="stylesheet" href="../../CSS/Multimediale/StyleVideo.css">
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
</head>
<body>

    <img src="../../Immagini/Video.jpg" class="sfondo-video" alt="Sfondo Video">
    ...
    // Inizializza un array vuoto che conterrà solo i libri di genere video trovati
    $risultati_video = [];
    ...
    echo '<h3>Libri di Genere: video</h3>';

    // Se l'array ha trovato libri video
    if (!empty($risultati_video)) {
        // Apre la lista non ordinata
        echo '<ul>';
    
        // Cicla i libri trovati per stamparli a schermo
        foreach ($risultati_video as $file) {
            echo '<li>';
            // Stampa Titolo e Autore
            echo '<strong>' . htmlspecialchars($file['titolo']) . '</strong> - ' . htmlspecialchars($file['autore']) . '<br>';
            // Stampa Genere e Anno di pubblicazione
            echo 'Genere: ' . htmlspecialchars($file['genere']) . ' (' . htmlspecialchars($file['anno']) . ')<br>';
            // Stampa il codice ISBN in piccolo
            echo '<small>ISBN: ' . htmlspecialchars($file['isbn']) . '</small>';
            echo '</li>';
        }
        ...
        // Messaggio mostrato nel caso in cui non ci siano libri video nel file di testo
        echo '<p>Nessun file video disponibile al momento.</p>';
    }
